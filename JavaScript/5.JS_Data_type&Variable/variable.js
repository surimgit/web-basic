...
/*
    동적 타이핑 : 변수의 타입이 데이터가 할당되는 순간에 결정
*/
var variable;
...
console.log(x);
/*
    var 키워드로 선언된 변수는 블록 레벨 스코프가 아닌 함수레벨 스코프를 가짐
    - 함수 레벨 스코프 : 함수 내에서 선언된 변수는 함수 안에서 사용 가능
    - 블록 레벨 스코프 : 함수 코드 블럭 내에서 선언된 변수는 해당 코드 블럭 내에서만 사용 가능
*/
...
/*
    ...
    - 이러한 문제를 해결하기 위해 ES6+부터는 var대신 let, const사용을 권장
*/
